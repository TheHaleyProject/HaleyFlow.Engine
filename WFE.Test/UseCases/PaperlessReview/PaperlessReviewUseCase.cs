    ...
    internal sealed class PaperlessReviewUseCase : IWorkflowUseCase {
        ...
        public async Task RunAsync(CancellationToken ct) {
            ...
            try {
                ...
                var wrapperDriver = serviceProvider.GetRequiredService<PaperlessReviewWrapper>();
        ...
        private static async Task PrintEntityTimelineAsync(
            ...
            PaperlessReviewUseCaseSettings settings,
            string entityId,
        ...
        private static async Task WaitForExitAsync(PaperlessReviewUseCaseSettings settings, CancellationToken ct) {
