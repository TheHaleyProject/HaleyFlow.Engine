...
namespace WFE.Test.UseCases.PaperlessReview {
    internal sealed class PaperlessReviewUseCase : IWorkflowUseCase {
        ...
        public async Task RunAsync(CancellationToken ct) {
            ...
            var dbName = $"wfe_test_paperless_review_{DateTime.UtcNow:yyyyMMddHHmmss}";
            settings.EngineConString = settings.EngineConString.Replace("wfe_test_case_paperless_review", dbName, StringComparison.OrdinalIgnoreCase);
