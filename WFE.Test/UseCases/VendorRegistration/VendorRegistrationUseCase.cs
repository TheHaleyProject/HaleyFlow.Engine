    ...
    internal sealed class VendorRegistrationUseCase : IWorkflowUseCase {
        ...
        public async Task RunAsync(CancellationToken ct) {
            ...
            try {
                ...
                var wrapperDriver = serviceProvider.GetRequiredService<VendorRegistrationWrapper>();
        ...
        private static async Task PrintEntityTimelineAsync(
            ...
            VendorRegistrationUseCaseSettings settings,
            string entityId,
        ...
        private static async Task WaitForExitAsync(VendorRegistrationUseCaseSettings settings, CancellationToken ct) {
