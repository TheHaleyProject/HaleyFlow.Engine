...
namespace Haley.Internal {
    internal sealed class MariaHookGroupDAL : MariaDALBase, IHookGroupDAL {
        ...
        public Task<int> CountUnresolvedInGroupAsync(long instanceId, long stateId, long viaEventId, bool onEntry, long lcId, long groupId, DbExecutionLoad load = default)
            => Db.ScalarAsync<int>(QRY_HOOK_GROUP.COUNT_UNRESOLVED_IN_GROUP, load, (INSTANCE_ID, instanceId), (STATE_ID, stateId), (EVENT_ID, viaEventId), (ON_ENTRY, onEntry ? 1 : 0), (LC_ID, lcId), (GROUP_ID, groupId));
    }
}
