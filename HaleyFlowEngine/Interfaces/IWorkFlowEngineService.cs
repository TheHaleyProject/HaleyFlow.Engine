...
public interface IWorkFlowEngineService : IWorkFlowEngineAccessor {
    ...
    Task<string?> GetTimelineHtmlAsync(int? envCode, string? defName, string? entityId, string? instanceGuid, string? displayName, TimelineDetail detail, CancellationToken ct);
