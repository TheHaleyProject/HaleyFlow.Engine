...
namespace Haley.Abstractions {
    internal interface IPolicyEnforcer {
        ...
        Task<IReadOnlyList<ILifeCycleHookEmission>> EmitHooksAsync(LifeCycleBlueprint bp, DbRow instance, ApplyTransitionResult applied, DbExecutionLoad load = default, string? resolvedPolicyJson = null, bool ackRequired = true);
