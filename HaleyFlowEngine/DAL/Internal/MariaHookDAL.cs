...
namespace Haley.Internal {
    internal sealed class MariaHookDAL : MariaDALBase, IHookDAL {
        ...
        public Task<long> UpsertByKeyReturnIdAsync(long instanceId, long stateId, long viaEventId, bool onEntry, string route, bool blocking, DbExecutionLoad load = default)
            => Db.ScalarAsync<long>(QRY_HOOK.UPSERT_BY_KEY_RETURN_ID, load, (INSTANCE_ID, instanceId), (STATE_ID, stateId), (EVENT_ID, viaEventId), (ON_ENTRY, onEntry ? 1 : 0), (ROUTE, route), (BLOCKING, blocking ? 1 : 0));
