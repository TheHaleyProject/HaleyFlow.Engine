...
namespace Haley.Internal {
    internal sealed class MariaRuntimeDataDAL : MariaDALBase, IRuntimeDataDAL {
        public MariaRuntimeDataDAL(IWorkFlowDALUtil db) : base(db) { }
        ...
        public Task<int> UpsertAsync(long runtimeId, string? data, string? payloadJson, DbExecutionLoad load = default)
            => Db.ExecAsync(QRY_RUNTIME_DATA.UPSERT, load, (ID, runtimeId), (DATA, data), (PAYLOAD, payloadJson));
