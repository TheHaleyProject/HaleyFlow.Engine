...
namespace Haley.Internal {
    internal static class QRY_ENGINE_HEALTH {
       ...
       WHERE e.code = {CODE}
        ...
        public const string COUNT_PENDING_ACKS =
            @"SELECT COUNT(*) AS cnt FROM ack_consumer WHERE status IN (1, 2);";
    }
}
