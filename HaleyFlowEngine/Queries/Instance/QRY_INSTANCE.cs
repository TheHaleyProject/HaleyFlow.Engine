...
namespace Haley.Internal {
    internal class QRY_INSTANCE {
        ...
        public const string LIST_BY_FLAGS_AND_DEF_VERSION_PAGED = $@"SELECT i.external_ref, i.guid AS instance_guid, i.created FROM instance i WHERE i.def_version = {PARENT_ID} AND (i.flags & {FLAGS}) <> 0 ORDER BY i.created ASC, i.id ASC LIMIT {TAKE} OFFSET {SKIP};";
